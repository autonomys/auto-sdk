...
`
      ...
      if (colors.explorerColors) {
        cssContent += `\n  /* Explorer Colors */\n`
        cssContent += generateCssVariables(colors.explorerColors, 'explorer-color')
      }

      // Add Explorer Gradients
      if (colors.gradients) {
        cssContent += `\n  /* Explorer Gradients */\n`
        cssContent += generateCssVariables(colors.gradients, 'explorer-gradient')
      }
...
`
      ...
      if (colors.explorerColors) {
        ...
        Object.entries(colors.explorerColors).forEach(([colorName, value]) => {
      ...
      if (colors.gradients) {
        ...
        if (colors.gradients.background) {
          Object.entries(colors.gradients.background).forEach(([name, value]) => {
        ...
        if (colors.gradients.button) {
          ...
          if (colors.gradients.button.hover) {
            Object.entries(colors.gradients.button.hover).forEach(([name, value]) => {
