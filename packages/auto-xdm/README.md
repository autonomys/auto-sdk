...
> **Network Compatibility:** The transporter precompile is currently available on **Chronos testnet** and local dev nodes. Mainnet support is coming soon. Use `isPrecompileDeployed()` to check availability at runtime.
...
// Setup provider and wallet (Chronos testnet)
const provider = new JsonRpcProvider('https://auto-evm.chronos.autonomys.xyz/ws')
